          ...
          <div className="flex-1 px-3 bg-white divide-y space-y-1">
            <ul className="space-y-2 pb-2">
              ...
              <li>
                <Link
                  href="/admin"
                  className={`text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group ${pathname === '/admin' ? 'bg-gray-100' : ''}`}
                >
              ...
              <li>
                <Link
                  href="/admin/users"
                  className={`text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ${pathname.startsWith('/admin/users') ? 'bg-gray-100' : ''}`}
                >
              ...
              {/* Tests (dropdown) */}
              <li>
                <div className={`text-base text-gray-900 font-normal rounded-lg flex flex-col w-full`}>
                  <button
                    onClick={() => setIsTestDropdownOpen(!isTestDropdownOpen)}
                    className={`w-full flex items-center p-2 hover:bg-gray-100 rounded-lg transition group ${isTestDropdownOpen ? 'bg-gray-100' : ''}`}
                  >
                    ...
                    <svg className={`w-4 h-4 ml-auto transition-transform duration-300 ${isTestDropdownOpen ? 'rotate-180' : ''}`} fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <div className={`overflow-hidden transition-all duration-300 ease-in-out ${isTestDropdownOpen ? 'max-h-40' : 'max-h-0'}`}>
                    <ul className="space-y-1 mt-1">
                      <li>
                        <Link
                          href="/admin/tests"
                          className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 pl-11 group"
                        >
              ...
              <li>
                <Link
                  href="/admin/billings"
                  className={`text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ${pathname.startsWith('/admin/billings') ? 'bg-gray-100' : ''}`}
                >
                  <svg className="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
