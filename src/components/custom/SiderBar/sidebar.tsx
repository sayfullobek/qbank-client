            ...
            <ul className="space-y-2 pb-2">
              ...
              <li>
                <Link
                  ...
                  onMouseLeave={e => e.currentTarget.style.backgroundColor = pathname === '/admin' ? activeBgColor : bgColor}
              ...
              <li>
                <Link
                  ...
                  onMouseEnter={e => e.currentTarget.style.backgroundColor = hoverBgColor}
                  onMouseLeave={e => e.currentTarget.style.backgroundColor = pathname.startsWith('/admin/users') ? activeBgColor : bgColor}
                  className="text-base font-normal rounded-lg flex items-center p-2 group transition"
                >
              ...
              <li className="rounded-xl">
                <div className="text-base font-normal rounded-lg flex flex-col w-full" style={{ color: textColor }}>
                  <button
                    ...
                    style={getLinkStyle(isTestDropdownOpen)}
                    onMouseEnter={e => e.currentTarget.style.backgroundColor = hoverBgColor}
                    onMouseLeave={e => e.currentTarget.style.backgroundColor = isTestDropdownOpen ? activeBgColor : bgColor}
                    ...
                    <ul className="space-y-1 mt-1">
                      <li>
                        <Link
                          ...
                          onMouseEnter={e => e.currentTarget.style.backgroundColor = hoverBgColor}
                          onMouseLeave={e => e.currentTarget.style.backgroundColor = pathname === '/admin/tests' ? activeBgColor : bgColor}
                      ...
                      <li>
                        <Link
                          ...
                          style={getLinkStyle(pathname === '/admin/tests/test')}
                          onMouseEnter={e => e.currentTarget.style.backgroundColor = hoverBgColor}
                          onMouseLeave={e => e.currentTarget.style.backgroundColor = pathname === '/admin/tests/test' ? activeBgColor : bgColor}
                          className="text-base font-normal rounded-lg flex items-center p-2 pl-11 group transition"
                        >
              ...
              <li>
                <Link
                  ...
                  onMouseEnter={e => e.currentTarget.style.backgroundColor = hoverBgColor}
                  onMouseLeave={e => e.currentTarget.style.backgroundColor = pathname.startsWith('/admin/billings') ? activeBgColor : bgColor}
                  className="text-base font-normal rounded-lg flex items-center p-2 group transition"
                >
                  <svg className="w-6 h-6 flex-shrink-0 transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" style={{ color: iconColor }}>
